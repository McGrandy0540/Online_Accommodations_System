...
class EmailService {
    ...
    public function sendConfirmationEmail($name, $email, $message) {
        try {
            ...
            // Email content
            $this->mail->isHTML(true);
            $this->mail->Subject = "Thank you for contacting UniHomes";
    ...
    private function createContactEmailTemplate($name, $email, $subject, $message) {
        ...
        <body>
            <div class='container'>
                ...
                <div class='footer'>
                    <p>This message was sent through the UniHomes contact form.</p>
...
---
This message was sent through the UniHomes contact form.
Please reply directly to {$email} to respond to this inquiry.
    ...
    private function createConfirmationEmailTemplate($name, $message) {
        ...
        <head>
            <meta charset='UTF-8'>
            <title>Thank you for contacting UniHomes</title>
            <style>
                body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; }
                .container { max-width: 600px; margin: 0 auto; padding: 20px; }
        ...
        <body>
            <div class='container'>
                ...
                <div class='footer'>
                    <p>Thank you for choosing UniHomes!</p>
...
---
Thank you for choosing UniHomes!
Your trusted partner for university accommodation solutions.
        ";
    }
